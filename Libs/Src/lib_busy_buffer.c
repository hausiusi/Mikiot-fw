...
void lib_busy_buffer_engage(busy_buffer_t* busy_buf, uint32_t timeout, uint32_t engaged_at) {
 ...
 * when tickcounter doesn't increase because of blocked interrupts.
 */
static void _wait_1ms() {
